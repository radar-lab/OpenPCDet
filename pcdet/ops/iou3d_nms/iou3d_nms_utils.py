...
def boxes_iou_bev(boxes_a, boxes_b):
    ...
    ans_iou = torch.zeros(boxes_a.shape[0], boxes_b.shape[0], dtype=torch.float32, device='cuda')
...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    # bev overlap
    overlaps_bev = torch.zeros(boxes_a.shape[0], boxes_b.shape[0], dtype=torch.float32, device='cuda')  # (N, M)
...
def boxes_aligned_iou3d_gpu(boxes_a, boxes_b):
    ...
    # bev overlap
    overlaps_bev = torch.zeros(boxes_a.shape[0], 1, dtype=torch.float32, device='cuda')  # (N, M)
...
def paired_boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    # bev overlap
    overlaps_bev = torch.zeros(boxes_a.shape[0], 1, dtype=torch.float32, device='cuda')  # (N,)
